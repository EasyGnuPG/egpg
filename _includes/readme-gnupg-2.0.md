...
## Installation
    ...
    git clone --branch gnupg-2.0 https://github.com/easygnupg/egpg
    cd egpg/
    sudo make install
...
For more details see the manual page: [http://easygnupg.github.io/egpg/gnupg-2.0/man/][1]
...
[1]: http://easygnupg.github.io/egpg/gnupg-2.0/man/
